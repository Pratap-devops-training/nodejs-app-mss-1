...
*/
app.get('/pratap', function(request, response) {
    //response.send("<h2><center>Hi Welcome to Test Web page</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Welcome to Pratap test page<center></h2>" );
    response.end();
